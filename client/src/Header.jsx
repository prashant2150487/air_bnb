...
const Header = () => {
    return (
        <header className='flex justify-between items-center border-b'>
            ...
            <div className="flex gap-2 border border-gray-300 rounded-full py-3 px-4 shadow-md shadow-gray-300 items-center">
                <div className='font-bold'>Anywhere</div>
                <div className='border border-gray-300 h-6'></div>
                <div >Any week</div>
                <div className='border border-gray-300 h-6'></div>
                <div>Any guests</div>
                <button className="bg-primary text-white  rounded-full p-1 h-6">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
                    </svg>
                </button>
            </div>
            <Link to={'/login'} className='flex items-center gap-2 border border-grey-300 rounded-full  py-2 px-2 h-fit '>
